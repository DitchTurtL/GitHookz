...
public class InteractionHandlerService
{
    ...
    public InteractionHandlerService(IOptions<GitHookzAppSettings> settings, DiscordSocketClient client, InteractionService handler, IServiceProvider services)
    {
